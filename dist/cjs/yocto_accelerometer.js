...
class YAccelerometer extends yocto_api_js_1.YSensor {
    ...
    static FindAccelerometer(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Accelerometer', func);
        if (obj == null) {
            obj = new YAccelerometer(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Accelerometer', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindAccelerometerInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Accelerometer', func);
        if (obj == null) {
...
YAccelerometer.BANDWIDTH_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YAccelerometer.XVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YAccelerometer.YVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YAccelerometer.ZVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
