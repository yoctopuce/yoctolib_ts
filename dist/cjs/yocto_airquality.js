...
class YAirQuality extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this.UBAINDEX_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.RELATIVEINDEX_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
    ...
    static FindAirQuality(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('AirQuality', func);
        if (obj == null) {
            obj = new YAirQuality(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('AirQuality', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindAirQualityInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'AirQuality', func);
        if (obj == null) {
    ...
    static FirstAirQuality() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('AirQuality');
        if (next_hwid == null)
            return null;
...
exports.YAirQuality = YAirQuality;
// API symbols as static members
YAirQuality.UBAINDEX_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YAirQuality.RELATIVEINDEX_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
