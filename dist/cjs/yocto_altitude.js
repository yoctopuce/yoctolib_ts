...
class YAltitude extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this.QNH_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.TECHNOLOGY_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
    ...
    static FindAltitude(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Altitude', func);
        if (obj == null) {
            obj = new YAltitude(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Altitude', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindAltitudeInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Altitude', func);
        if (obj == null) {
    ...
    /**
     * Retrieves the first Altitude in a YAPI context
     *
     * @returns {YAltitude}
     */
    static FirstAltitude() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Altitude');
        if (next_hwid == null)
            return null;
        return YAltitude.FindAltitude(next_hwid);
    }
    /**
     * Retrieves the first Altitude in a given context
     *
...
YAltitude.QNH_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YAltitude.TECHNOLOGY_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
