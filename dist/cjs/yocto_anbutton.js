...
class YAnButton extends yocto_api_js_1.YFunction {
    ...
    static FindAnButton(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('AnButton', func);
        if (obj == null) {
            obj = new YAnButton(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('AnButton', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindAnButtonInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'AnButton', func);
        if (obj == null) {
    ...
    static FirstAnButton() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('AnButton');
        if (next_hwid == null)
            return null;
