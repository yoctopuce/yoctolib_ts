...
class YAngularSpeed extends yocto_api_js_1.YSensor {
    // API symbols as static members
    //--- (end of YAngularSpeed attributes declaration)
    constructor(yapi, func) {
        //--- (YAngularSpeed constructor)
        super(yapi, func);
        this._valueCallbackAngularSpeed = null;
        this._timedReportCallbackAngularSpeed = null;
    ...
    static FindAngularSpeed(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('AngularSpeed', func);
        if (obj == null) {
            obj = new YAngularSpeed(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('AngularSpeed', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindAngularSpeedInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'AngularSpeed', func);
        if (obj == null) {
    ...
    static FirstAngularSpeed() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('AngularSpeed');
        if (next_hwid == null)
            return null;
...
exports.YAngularSpeed = YAngularSpeed;
//# sourceMappingURL=yocto_angularspeed.js.map