...
class YBluetoothLink extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.OWNADDRESS_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
    ...
    static FindBluetoothLink(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('BluetoothLink', func);
        if (obj == null) {
            obj = new YBluetoothLink(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('BluetoothLink', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindBluetoothLinkInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'BluetoothLink', func);
        if (obj == null) {
...
YBluetoothLink.OWNADDRESS_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
