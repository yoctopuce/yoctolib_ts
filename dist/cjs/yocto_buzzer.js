...
class YBuzzer extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.PLAYSEQSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.PLAYSEQMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.PLAYSEQSIGNATURE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindBuzzer(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Buzzer', func);
        if (obj == null) {
            obj = new YBuzzer(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Buzzer', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindBuzzerInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Buzzer', func);
        if (obj == null) {
     ...
     */
    static FirstBuzzer() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Buzzer');
        if (next_hwid == null)
            return null;
...
YBuzzer.FREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YBuzzer.VOLUME_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YBuzzer.PLAYSEQSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YBuzzer.PLAYSEQMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YBuzzer.PLAYSEQSIGNATURE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YBuzzer.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
