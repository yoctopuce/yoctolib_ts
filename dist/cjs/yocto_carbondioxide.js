...
/*********************************************************************
 *
 *  $Id: yocto_carbondioxide.ts 55359 2023-06-28 09:25:04Z seb $
 *
...
class YCarbonDioxide extends yocto_api_js_1.YSensor {
    ...
    static FindCarbonDioxide(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('CarbonDioxide', func);
        if (obj == null) {
            obj = new YCarbonDioxide(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('CarbonDioxide', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindCarbonDioxideInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'CarbonDioxide', func);
        if (obj == null) {
    ...
    static FirstCarbonDioxide() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('CarbonDioxide');
        if (next_hwid == null)
            return null;
