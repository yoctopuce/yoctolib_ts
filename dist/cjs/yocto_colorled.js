...
class YColorLed extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.RGBCOLOR_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.HSLCOLOR_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.RGBCOLORATPOWERON_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.BLINKSEQSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.BLINKSEQMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.BLINKSEQSIGNATURE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindColorLed(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('ColorLed', func);
        if (obj == null) {
            obj = new YColorLed(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('ColorLed', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindColorLedInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'ColorLed', func);
        if (obj == null) {
    ...
    static FirstColorLed() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('ColorLed');
        if (next_hwid == null)
            return null;
...
YColorLed.BLINKSEQSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YColorLed.BLINKSEQMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YColorLed.BLINKSEQSIGNATURE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YColorLed.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
