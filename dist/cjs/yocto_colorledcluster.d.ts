...
export declare class YColorLedCluster extends YFunction {
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    shl_rgb(rgbValue: number): Promise<number>;
    /**
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    shr_rgb(rgbValue: number): Promise<number>;
    /**
     * Changes the color displayed by the last LED and shifts all currently displayed colors
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    shl_hsl(hslValue: number): Promise<number>;
    /**
     * Changes the color displayed by the first LED and shifts all currently displayed colors
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    shr_hsl(hslValue: number): Promise<number>;
    /**
