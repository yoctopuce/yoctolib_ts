...
class YGroundSpeed extends yocto_api_js_1.YSensor {
    ...
    static FindGroundSpeed(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('GroundSpeed', func);
        if (obj == null) {
            obj = new YGroundSpeed(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('GroundSpeed', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindGroundSpeedInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'GroundSpeed', func);
        if (obj == null) {
    ...
    static FirstGroundSpeed() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('GroundSpeed');
        if (next_hwid == null)
            return null;
