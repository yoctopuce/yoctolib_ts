...
exports.YGyro = exports.YQt = void 0;
...
class YQt extends yocto_api_js_1.YSensor {
    ...
    static FindQt(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Qt', func);
        if (obj == null) {
            obj = new YQt(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Qt', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindQtInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Qt', func);
        if (obj == null) {
     ...
     */
    static FirstQt() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Qt');
        if (next_hwid == null)
            return null;
...
/** @extends {YFunction} **/
class YGyro extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this.XVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.YVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.ZVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
    ...
    static FindGyro(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Gyro', func);
        if (obj == null) {
            obj = new YGyro(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Gyro', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindGyroInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Gyro', func);
        if (obj == null) {
     ...
     */
    static FirstGyro() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Gyro');
        if (next_hwid == null)
            return null;
...
exports.YGyro = YGyro;
// API symbols as static members
YGyro.BANDWIDTH_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YGyro.XVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YGyro.YVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YGyro.ZVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
