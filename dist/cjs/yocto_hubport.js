...
class YHubPort extends yocto_api_js_1.YFunction {
    ...
    static FindHubPort(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('HubPort', func);
        if (obj == null) {
            obj = new YHubPort(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('HubPort', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindHubPortInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'HubPort', func);
        if (obj == null) {
     ...
     */
    static FirstHubPort() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('HubPort');
        if (next_hwid == null)
            return null;
