...
class YInputChain extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.EXPECTEDNODES_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.DETECTEDNODES_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        ...
        this.BITCHAIN1_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN2_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN3_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN4_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN5_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN6_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.BITCHAIN7_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.WATCHDOGPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.CHAINDIAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    imm_parseAttr(name, val) {
        switch (name) {
            ...
            case 'bitChain7':
                ...
                return 1;
            case 'watchdogPeriod':
                this._watchdogPeriod = val;
                return 1;
            case 'chainDiags':
                this._chainDiags = val;
                return 1;
        }
    ...
    static FindInputChain(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('InputChain', func);
        if (obj == null) {
            obj = new YInputChain(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('InputChain', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindInputChainInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'InputChain', func);
        if (obj == null) {
    ...
    static FirstInputChain() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('InputChain');
        if (next_hwid == null)
            return null;
...
exports.YInputChain = YInputChain;
// API symbols as static members
YInputChain.EXPECTEDNODES_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YInputChain.DETECTEDNODES_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YInputChain.LOOPBACKTEST_OFF = 0;
YInputChain.LOOPBACKTEST_ON = 1;
YInputChain.LOOPBACKTEST_INVALID = -1;
YInputChain.REFRESHRATE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YInputChain.BITCHAIN1_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN2_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN3_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN4_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN5_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN6_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.BITCHAIN7_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YInputChain.WATCHDOGPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YInputChain.CHAINDIAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
//# sourceMappingURL=yocto_inputchain.js.map