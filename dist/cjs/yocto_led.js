...
class YLed extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.LUMINOSITY_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindLed(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Led', func);
        if (obj == null) {
            obj = new YLed(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Led', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindLedInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Led', func);
        if (obj == null) {
     ...
     */
    static FirstLed() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Led');
        if (next_hwid == null)
            return null;
...
YLed.LUMINOSITY_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
