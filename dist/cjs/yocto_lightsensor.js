...
class YLightSensor extends yocto_api_js_1.YSensor {
    ...
    static FindLightSensor(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('LightSensor', func);
        if (obj == null) {
            obj = new YLightSensor(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('LightSensor', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindLightSensorInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'LightSensor', func);
        if (obj == null) {
    ...
    static FirstLightSensor() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('LightSensor');
        if (next_hwid == null)
            return null;
