...
/*********************************************************************
 *
 *  $Id: yocto_magnetometer.ts 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YMagnetometer extends yocto_api_js_1.YSensor {
    ...
    static FindMagnetometer(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Magnetometer', func);
        if (obj == null) {
            obj = new YMagnetometer(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Magnetometer', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindMagnetometerInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Magnetometer', func);
        if (obj == null) {
    ...
    static FirstMagnetometer() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Magnetometer');
        if (next_hwid == null)
            return null;
...
YMagnetometer.BANDWIDTH_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YMagnetometer.XVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YMagnetometer.YVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YMagnetometer.ZVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
