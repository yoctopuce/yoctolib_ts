...
/*********************************************************************
 *
 *  $Id: yocto_motor.ts 59977 2024-03-18 15:02:32Z mvuilleu $
 *
...
class YMotor extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.OVERCURRENTLIMIT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.FREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.STARTERTIME_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.FAILSAFETIMEOUT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindMotor(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Motor', func);
        if (obj == null) {
            obj = new YMotor(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Motor', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindMotorInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Motor', func);
        if (obj == null) {
     ...
     */
    static FirstMotor() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Motor');
        if (next_hwid == null)
            return null;
...
YMotor.OVERCURRENTLIMIT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YMotor.FREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YMotor.STARTERTIME_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YMotor.FAILSAFETIMEOUT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YMotor.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
