...
export declare class YOrientation extends YSensor {
    _className: string;
    _counterClockwise: YOrientation.COUNTERCLOCKWISE;
    _command: string;
    _zeroOffset: number;
    ...
    readonly COUNTERCLOCKWISE_FALSE: YOrientation.COUNTERCLOCKWISE;
    readonly COUNTERCLOCKWISE_TRUE: YOrientation.COUNTERCLOCKWISE;
    readonly COUNTERCLOCKWISE_INVALID: YOrientation.COUNTERCLOCKWISE;
    readonly COMMAND_INVALID: string;
    readonly ZEROOFFSET_INVALID: number;
    static readonly COUNTERCLOCKWISE_FALSE: YOrientation.COUNTERCLOCKWISE;
    static readonly COUNTERCLOCKWISE_TRUE: YOrientation.COUNTERCLOCKWISE;
    static readonly COUNTERCLOCKWISE_INVALID: YOrientation.COUNTERCLOCKWISE;
     ...
     */
    get_counterClockwise(): Promise<YOrientation.COUNTERCLOCKWISE>;
    /**
     ...
     */
    set_counterClockwise(newval: YOrientation.COUNTERCLOCKWISE): Promise<number>;
