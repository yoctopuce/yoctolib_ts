...
class YOrientation extends yocto_api_js_1.YSensor {
    ...
    static FindOrientation(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Orientation', func);
        if (obj == null) {
            obj = new YOrientation(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Orientation', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindOrientationInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Orientation', func);
        if (obj == null) {
    ...
    static FirstOrientation() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Orientation');
        if (next_hwid == null)
            return null;
