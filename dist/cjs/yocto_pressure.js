...
class YPressure extends yocto_api_js_1.YSensor {
    ...
    static FindPressure(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Pressure', func);
        if (obj == null) {
            obj = new YPressure(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Pressure', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindPressureInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Pressure', func);
        if (obj == null) {
...
//# sourceMappingURL=yocto_pressure.js.map