...
class YPwmInput extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this.DEBOUNCEPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.MINFREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.BANDWIDTH_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.EDGESPERPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindPwmInput(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('PwmInput', func);
        if (obj == null) {
            obj = new YPwmInput(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('PwmInput', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindPwmInputInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'PwmInput', func);
        if (obj == null) {
    ...
    static FirstPwmInput() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('PwmInput');
        if (next_hwid == null)
            return null;
...
YPwmInput.DUTYCYCLE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YPwmInput.PULSEDURATION_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YPwmInput.FREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YPwmInput.PERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YPwmInput.PULSECOUNTER_INVALID = yocto_api_js_1.YAPI.INVALID_LONG;
YPwmInput.PULSETIMER_INVALID = yocto_api_js_1.YAPI.INVALID_LONG;
...
YPwmInput.DEBOUNCEPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YPwmInput.MINFREQUENCY_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YPwmInput.BANDWIDTH_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YPwmInput.EDGESPERPERIOD_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
