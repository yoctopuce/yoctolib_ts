...
class YPwmPowerSource extends yocto_api_js_1.YFunction {
    ...
    static FindPwmPowerSource(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('PwmPowerSource', func);
        if (obj == null) {
            obj = new YPwmPowerSource(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('PwmPowerSource', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindPwmPowerSourceInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'PwmPowerSource', func);
        if (obj == null) {
    ...
    static FirstPwmPowerSource() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('PwmPowerSource');
        if (next_hwid == null)
            return null;
