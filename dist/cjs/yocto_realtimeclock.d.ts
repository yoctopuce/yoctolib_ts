...
export declare const enum Y_TimeSet {
    FALSE = 0,
    TRUE = 1,
    INVALID = -1
}
...
export declare class YRealTimeClock extends YFunction {
    ...
    readonly TIMESET_FALSE: Y_TimeSet;
    readonly TIMESET_TRUE: Y_TimeSet;
    readonly TIMESET_INVALID: Y_TimeSet;
    static readonly UNIXTIME_INVALID: number;
    static readonly DATETIME_INVALID: string;
    static readonly UTCOFFSET_INVALID: number;
    static readonly TIMESET_FALSE: Y_TimeSet;
    static readonly TIMESET_TRUE: Y_TimeSet;
    static readonly TIMESET_INVALID: Y_TimeSet;
