...
export declare class YRfidTagInfo {
    ...
    readonly IEC_15693_ST25DV: number;
    readonly IEC_15693_ST25TV: number;
    readonly IEC_15693_TAGIT_HFI: number;
    readonly IEC_15693_MB89R: number;
    readonly IEC_15693_ICODE_DNA: number;
    readonly IEC_15693_ICODE_SLI: number;
    ...
    static readonly IEC_15693_ST25DV: number;
    static readonly IEC_15693_ST25TV: number;
    static readonly IEC_15693_TAGIT_HFI: number;
    static readonly IEC_15693_MB89R: number;
    static readonly IEC_15693_ICODE_DNA: number;
    static readonly IEC_15693_ICODE_SLI: number;
    constructor();
    /**
...
export declare class YRfidStatus {
    ...
    readonly NOT_AVAILABLE_ON_THIS_TAG: number;
    readonly PASSWORD_FEATURE_NOT_SUPPORTED: number;
    readonly BAD_PASSWORD_LENGTH: number;
    readonly BAD_PASSWORD_TYPE: number;
    readonly BAD_PASSWORD: number;
    readonly PASSWORD_REQUIRED: number;
    readonly MULTIWRITE_NOT_SUPPORTED: number;
    readonly MULTIREAD_NOT_SUPPORTED: number;
    ...
    static readonly NOT_AVAILABLE_ON_THIS_TAG: number;
    static readonly PASSWORD_FEATURE_NOT_SUPPORTED: number;
    static readonly BAD_PASSWORD_LENGTH: number;
    static readonly BAD_PASSWORD_TYPE: number;
    static readonly BAD_PASSWORD: number;
    static readonly PASSWORD_REQUIRED: number;
    static readonly MULTIWRITE_NOT_SUPPORTED: number;
    static readonly MULTIREAD_NOT_SUPPORTED: number;
    constructor();
    /**
...
export declare class YRfidOptions {
    ...
    readonly ST25DV_CONFIG_PWD: number;
    readonly ST25DV_PWD1: number;
    readonly ST25DV_PWD2: number;
    readonly ST25DV_PWD3: number;
    readonly ST25TV_CONFIG_PWD: number;
    readonly ST25TV_PWD1: number;
    readonly ST25TV_PWD2: number;
    static readonly NO_RFID_KEY: number;
    static readonly MIFARE_KEY_A: number;
    static readonly MIFARE_KEY_B: number;
    static readonly ST25DV_CONFIG_PWD: number;
    static readonly ST25DV_PWD1: number;
    static readonly ST25DV_PWD2: number;
    static readonly ST25DV_PWD3: number;
    static readonly ST25TV_CONFIG_PWD: number;
    static readonly ST25TV_PWD1: number;
    static readonly ST25TV_PWD2: number;
    constructor();
...
export declare class YRfidReader extends YFunction {
     ...
     * happens, you can get more information from the status object.
     */
    tagWriteBinNFC(tagId: string, ndefType: string, payload: Uint8Array, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
     ...
     * happens, you can get more information from the status object.
     */
    tagWriteUrlNFC(tagId: string, url: string, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
     ...
     * happens, you can get more information from the status object.
     */
    tagWriteWifiConfigNFC(tagId: string, ssid: string, auth: string, secret: string, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
     ...
     * happens, you can get more information from the status object.
     */
    tagGetConfigByte(tagId: string, addr: number, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
     ...
     * happens, you can get more information from the status object.
     */
    tagSetConfigByte(tagId: string, addr: number, value: number, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
     ...
     * happens, you can get more information from the status object.
     */
    tagSetPassword(tagId: string, passwordType: number, password: string, options: YRfidOptions, status: YRfidStatus): Promise<number>;
    /**
