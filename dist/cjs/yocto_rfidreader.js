...
exports.YRfidReader = exports.YRfidOptions = exports.YRfidStatus = exports.YRfidTagInfo = void 0;
...
exports.YRfidTagInfo = YRfidTagInfo;
...
class YRfidStatus {
    ...
    imm_init(tagId, errCode, errBlk, fab, lab) {
        let errMsg;
        if (errCode == 0) {
            this._yapierr = yocto_api_js_1.YAPI.SUCCESS;
            ...
            if (errCode < 0) {
                if (errCode > -50) {
                    ...
                    this._yapierr = yocto_api_js_1.YAPI.RFID_HARD_ERROR;
                    errMsg = 'Non-recoverable RFID error ' + String(Math.round(errCode));
                }
            }
            else {
                if (errCode > 1000) {
                    this._yapierr = yocto_api_js_1.YAPI.RFID_SOFT_ERROR;
...
exports.YRfidStatus = YRfidStatus;
// API symbols as static members
...
exports.YRfidOptions = YRfidOptions;
// API symbols as static members
...
class YRfidReader extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this._eventStamp = 0;
        // API symbols as object properties
        this.NTAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.REFRESHRATE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
    ...
    static FindRfidReader(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('RfidReader', func);
        if (obj == null) {
            obj = new YRfidReader(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('RfidReader', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindRfidReaderInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'RfidReader', func);
        if (obj == null) {
    ...
    async _chkerror(tagId, json, status) {
        ...
        if ((json).length == 0) {
            ...
            errCode = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'err'));
            errBlk = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'errBlk')) - 1;
            if ((jsonStr).indexOf('"fab":') >= 0) {
                fab = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'fab')) - 1;
                lab = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'lab')) - 1;
            }
            else {
                fab = -1;
                lab = -1;
    ...
    async get_tagInfo(tagId, status) {
        ...
        tagType = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'type'));
        size = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'size'));
        usable = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'usable'));
        blksize = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'blksize'));
        fblk = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'fblk'));
        lblk = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'lblk'));
     ...
     * happens, you can get more information from the status object.
     */
    async tagWriteBinNFC(tagId, ndefType, payload, options, status) {
        let tagInfo;
        let nfcType;
        let usableSize;
        let nfcBlocks;
     ...
     * happens, you can get more information from the status object.
     */
    async tagWriteUrlNFC(tagId, url, options, status) {
        let prefix;
        let binUrl;
        prefix = 0;
     ...
     * happens, you can get more information from the status object.
     */
    async tagWriteWifiConfigNFC(tagId, ssid, auth, secret, options, status) {
        let ssidBin;
        let ssidLen;
        let secretBin;
        let secretLen;
    ...
    async tagGetAFI(tagId, options, status) {
        ...
        await this._chkerror(tagId, json, status);
        if (await status.get_yapiError() == this._yapi.SUCCESS) {
            res = yocto_api_js_1.YAPIContext.imm_atoi(this.imm_json_get_key(json, 'res'));
        }
        else {
    ...
    static FirstRfidReader() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('RfidReader');
        if (next_hwid == null)
            return null;
...
exports.YRfidReader = YRfidReader;
// API symbols as static members
YRfidReader.NTAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YRfidReader.REFRESHRATE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
