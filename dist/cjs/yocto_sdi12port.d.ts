 ...
 *
 */
export declare class YSdi12SnoopingRecord {
    _tim: number;
    _pos: number;
    _dir: number;
    _msg: string;
...
export declare namespace YSdi12SnoopingRecord {
}
/**
 ...
 */
/** @extends {YFunction} **/
export declare class YSdi12Port extends YFunction {
    _className: string;
    _rxCount: number;
    _txCount: number;
    _errCount: number;
    ...
    _command: string;
    _protocol: string;
    _voltageLevel: YSdi12Port.VOLTAGELEVEL;
    _serialMode: string;
    _valueCallbackSdi12Port: YSdi12Port.ValueCallback | null;
    _rxptr: number;
    _rxbuff: Uint8Array;
    _rxbuffptr: number;
    _eventPos: number;
    ...
    readonly VOLTAGELEVEL_OFF: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_TTL3V: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_TTL3VR: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_TTL5V: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_TTL5VR: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_RS232: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_RS485: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_TTL1V8: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_SDI12: YSdi12Port.VOLTAGELEVEL;
    readonly VOLTAGELEVEL_INVALID: YSdi12Port.VOLTAGELEVEL;
    ...
    static readonly VOLTAGELEVEL_OFF: YSdi12Port.VOLTAGELEVEL;
     ...
     */
    get_voltageLevel(): Promise<YSdi12Port.VOLTAGELEVEL>;
    /**
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    set_voltageLevel(newval: YSdi12Port.VOLTAGELEVEL): Promise<number>;
    /**
     ...
     * @noreturn
     */
    registerValueCallback(callback: YSdi12Port.ValueCallback | null): Promise<number>;
     ...
     * On failure, throws an exception or returns an empty string.
     */
    querySdi12(sensorAddr: string, cmd: string, maxWait: number): Promise<string>;
    /**
     ...
     * On failure, throws an exception or returns an empty string.
     */
    readSensor(sensorAddr: string, measCmd: string, maxWait: number): Promise<number[]>;
    /**
     ...
     * On failure, throws an exception or returns an empty string.
     */
    readConcurrentMeasurements(sensorAddr: string): Promise<number[]>;
    /**
     * Sends a information command to the bus, and reads sensors information selected.
     * This function is intended to be used when the serial port is configured for 'SDI-12' protocol.
     *
     ...
     * On failure, throws an exception or returns an empty string.
     */
    requestConcurrentMeasurements(sensorAddr: string): Promise<number>;
    /**
     ...
     * On failure, throws an exception or returns an empty array.
     */
    snoopMessages(maxWait: number): Promise<YSdi12SnoopingRecord[]>;
    /**
...
export declare namespace YSdi12Port {
    ...
    interface ValueCallback {
        (func: YSdi12Port, value: string): void;
    }
}
