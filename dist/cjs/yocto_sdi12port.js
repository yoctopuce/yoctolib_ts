...
exports.YSdi12SnoopingRecord = YSdi12SnoopingRecord;
...
//--- (end of generated code: YSdi12Port class start)
/** @extends {YFunction} **/
class YSdi12Port extends yocto_api_js_1.YFunction {
    ...
    static FindSdi12Port(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Sdi12Port', func);
        if (obj == null) {
            obj = new YSdi12Port(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Sdi12Port', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindSdi12PortInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Sdi12Port', func);
        if (obj == null) {
    ...
    async readSensor(sensorAddr, measCmd, maxWait) {
        ...
        valdouble = yocto_api_js_1.YAPIContext.imm_atof(split[1]);
        res.push(valdouble);
        i = 1;
        while (i < tab.length) {
            valdouble = yocto_api_js_1.YAPIContext.imm_atof(tab[i]);
            res.push(valdouble);
            i = i + 1;
        }
        return res;
    ...
    static FirstSdi12Port() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Sdi12Port');
        if (next_hwid == null)
            return null;
...
exports.YSdi12Port = YSdi12Port;
// API symbols as static members
YSdi12Port.RXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.TXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.ERRCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.RXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.TXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.LASTMSG_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSdi12Port.CURRENTJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSdi12Port.STARTUPJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSdi12Port.JOBMAXTASK_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.JOBMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSdi12Port.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSdi12Port.PROTOCOL_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
...
YSdi12Port.SERIALMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
