...
/*********************************************************************
 *
 *  $Id: yocto_serialport.ts 70736 2025-12-12 07:53:30Z mvuilleu $
 *
...
/** @extends {YFunction} **/
class YSerialPort extends yocto_api_js_1.YFunction {
    ...
    async _internalEventCallback(YSerialPort_obj, str_value) {
    ...
    static FindSerialPort(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('SerialPort', func);
        if (obj == null) {
            obj = new YSerialPort(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('SerialPort', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindSerialPortInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'SerialPort', func);
        if (obj == null) {
    ...
    static FirstSerialPort() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('SerialPort');
        if (next_hwid == null)
            return null;
...
// API symbols as static members
YSerialPort.RXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSerialPort.TXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSerialPort.ERRCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSerialPort.RXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSerialPort.TXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSerialPort.LASTMSG_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSerialPort.CURRENTJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSerialPort.STARTUPJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSerialPort.JOBMAXTASK_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
...
YSerialPort.VOLTAGELEVEL_SDI12 = 8;
