...
class YSoundLevel extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this.LABEL_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
    ...
    static FindSoundLevel(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('SoundLevel', func);
        if (obj == null) {
            obj = new YSoundLevel(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('SoundLevel', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindSoundLevelInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'SoundLevel', func);
        if (obj == null) {
    ...
    static FirstSoundLevel() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('SoundLevel');
        if (next_hwid == null)
            return null;
...
exports.YSoundLevel = YSoundLevel;
// API symbols as static members
YSoundLevel.LABEL_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSoundLevel.INTEGRATIONTIME_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
