...
/*********************************************************************
 *
 *  $Id: yocto_spiport.ts 72057 2026-02-17 09:44:53Z mvuilleu $
 *
...
exports.YSpiPort = exports.YSpiSnoopingRecord = void 0;
...
exports.YSpiSnoopingRecord = YSpiSnoopingRecord;
...
/** @extends {YFunction} **/
class YSpiPort extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.SPIMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
    ...
    static FindSpiPort(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('SpiPort', func);
        if (obj == null) {
            obj = new YSpiPort(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('SpiPort', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindSpiPortInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'SpiPort', func);
        if (obj == null) {
     ...
     */
    static FirstSpiPort() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('SpiPort');
        if (next_hwid == null)
            return null;
...
exports.YSpiPort = YSpiPort;
// API symbols as static members
YSpiPort.RXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.TXCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.ERRCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.RXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.TXMSGCOUNT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.LASTMSG_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSpiPort.CURRENTJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSpiPort.STARTUPJOB_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSpiPort.JOBMAXTASK_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.JOBMAXSIZE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YSpiPort.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YSpiPort.PROTOCOL_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
...
YSpiPort.SPIMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
