...
class YStepperMotor extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.DIAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.STEPPOS_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.SPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.PULLINSPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.MAXACCEL_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        this.MAXSPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
        ...
        this.OVERCURRENT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.TCURRSTOP_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.TCURRRUN_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.ALERTMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.AUXMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
        this.AUXSIGNAL_INVALID = yocto_api_js_1.YAPI.INVALID_INT;
    ...
    static FindStepperMotor(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('StepperMotor', func);
        if (obj == null) {
            obj = new YStepperMotor(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('StepperMotor', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindStepperMotorInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'StepperMotor', func);
        if (obj == null) {
...
YStepperMotor.DIAGS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YStepperMotor.STEPPOS_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YStepperMotor.SPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YStepperMotor.PULLINSPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YStepperMotor.MAXACCEL_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
YStepperMotor.MAXSPEED_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
...
YStepperMotor.OVERCURRENT_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YStepperMotor.TCURRSTOP_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YStepperMotor.TCURRRUN_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YStepperMotor.ALERTMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YStepperMotor.AUXMODE_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
YStepperMotor.AUXSIGNAL_INVALID = yocto_api_js_1.YAPI.INVALID_INT;
YStepperMotor.COMMAND_INVALID = yocto_api_js_1.YAPI.INVALID_STRING;
