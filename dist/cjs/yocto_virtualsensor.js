...
class YVirtualSensor extends yocto_api_js_1.YSensor {
    ...
    constructor(yapi, func) {
        ...
        this._valueCallbackVirtualSensor = null;
        this._timedReportCallbackVirtualSensor = null;
        // API symbols as object properties
        this.INVALIDVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
    ...
    static FindVirtualSensor(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('VirtualSensor', func);
        if (obj == null) {
            obj = new YVirtualSensor(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('VirtualSensor', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindVirtualSensorInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'VirtualSensor', func);
        if (obj == null) {
    ...
    static FirstVirtualSensor() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('VirtualSensor');
        if (next_hwid == null)
            return null;
...
exports.YVirtualSensor = YVirtualSensor;
// API symbols as static members
YVirtualSensor.INVALIDVALUE_INVALID = yocto_api_js_1.YAPI.INVALID_DOUBLE;
//# sourceMappingURL=yocto_virtualsensor.js.map