...
class YWakeUpSchedule extends yocto_api_js_1.YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.MINUTESA_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.MINUTESB_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.HOURS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.WEEKDAYS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.MONTHDAYS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.MONTHS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.SECONDSBEFORE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
        this.NEXTOCCURENCE_INVALID = yocto_api_js_1.YAPI.INVALID_LONG;
    ...
    static FindWakeUpSchedule(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('WakeUpSchedule', func);
        if (obj == null) {
            obj = new YWakeUpSchedule(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('WakeUpSchedule', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindWakeUpScheduleInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'WakeUpSchedule', func);
        if (obj == null) {
...
YWakeUpSchedule.MINUTESA_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.MINUTESB_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.HOURS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.WEEKDAYS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.MONTHDAYS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.MONTHS_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.SECONDSBEFORE_INVALID = yocto_api_js_1.YAPI.INVALID_UINT;
YWakeUpSchedule.NEXTOCCURENCE_INVALID = yocto_api_js_1.YAPI.INVALID_LONG;
