...
/** @extends {YFunction} **/
class YWireless extends yocto_api_js_1.YFunction {
    ...
    static FindWireless(func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCache('Wireless', func);
        if (obj == null) {
            obj = new YWireless(yocto_api_js_1.YAPI, func);
            yocto_api_js_1.YFunction._AddToCache('Wireless', func, obj);
        }
        return obj;
    }
    /**
    ...
    static FindWirelessInContext(yctx, func) {
        let obj;
        obj = yocto_api_js_1.YFunction._FindFromCacheInContext(yctx, 'Wireless', func);
        if (obj == null) {
    ...
    async get_detectedWlans() {
        ...
        res.length = 0;
        for (let ii_0 of wlanlist) {
            res.push(new YWlanRecord(this._yapi.imm_bin2str(ii_0)));
        }
        return res;
    }
    /**
    ...
    static FirstWireless() {
        let next_hwid = yocto_api_js_1.YAPI.imm_getFirstHardwareId('Wireless');
        if (next_hwid == null)
            return null;
