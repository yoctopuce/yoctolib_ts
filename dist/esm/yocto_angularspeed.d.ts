 ...
 */
export declare class YAngularSpeed extends YSensor {
    _className: string;
    _valueCallbackAngularSpeed: YAngularSpeed.ValueCallback | null;
    _timedReportCallbackAngularSpeed: YAngularSpeed.TimedReportCallback | null;
     ...
     * @noreturn
     */
    registerValueCallback(callback: YAngularSpeed.ValueCallback | null): Promise<number>;
     ...
     * @noreturn
     */
    registerTimedReportCallback(callback: YAngularSpeed.TimedReportCallback | null): Promise<number>;
...
export declare namespace YAngularSpeed {
    interface ValueCallback {
        (func: YAngularSpeed, value: string): void;
    }
    interface TimedReportCallback {
        (func: YAngularSpeed, measure: YMeasure): void;
    }
}
