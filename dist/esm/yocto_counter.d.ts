...
export declare class YCounter extends YSensor {
    _className: string;
    _decimalMode: YCounter.DECIMALMODE;
    _command: string;
    _valueCallbackCounter: YCounter.ValueCallback | null;
    _timedReportCallbackCounter: YCounter.TimedReportCallback | null;
    readonly DECIMALMODE_FALSE: YCounter.DECIMALMODE;
    readonly DECIMALMODE_TRUE: YCounter.DECIMALMODE;
    readonly DECIMALMODE_INVALID: YCounter.DECIMALMODE;
    readonly COMMAND_INVALID: string;
    static readonly DECIMALMODE_FALSE: YCounter.DECIMALMODE;
    static readonly DECIMALMODE_TRUE: YCounter.DECIMALMODE;
    static readonly DECIMALMODE_INVALID: YCounter.DECIMALMODE;
     ...
     */
    get_decimalMode(): Promise<YCounter.DECIMALMODE>;
    /**
     ...
     */
    set_decimalMode(newval: YCounter.DECIMALMODE): Promise<number>;
