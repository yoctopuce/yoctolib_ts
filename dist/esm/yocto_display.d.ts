 ...
 *
 *********************************************************************/
import { YAPIContext, YErrorMsg, YFunction } from './yocto_api.js';
/**
...
export declare class YDisplayLayer {
    ...
    command_push(cmd: string): Promise<number>;
    command_flush(cmd: string): Promise<number>;
    /**
...
export declare class YDisplay extends YFunction {
     ...
     */
    get_ePaperState(errmsg: YErrorMsg): Promise<YDisplay.DISPLAYSTATE>;
    /**
