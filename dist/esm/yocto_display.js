...
export class YDisplay extends YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.STARTUPSEQ_INVALID = YAPI.INVALID_STRING;
        this.BRIGHTNESS_INVALID = YAPI.INVALID_UINT;
        this.AUTOINVERTDELAY_INVALID = YAPI.INVALID_UINT;
        this.ORIENTATION_LEFT = 0;
        this.ORIENTATION_UP = 1;
        this.ORIENTATION_RIGHT = 2;
        this.ORIENTATION_DOWN = 3;
        this.ORIENTATION_INVALID = -1;
        this.DISPLAYPANEL_INVALID = YAPI.INVALID_STRING;
        this.DISPLAYWIDTH_INVALID = YAPI.INVALID_UINT;
        this.DISPLAYHEIGHT_INVALID = YAPI.INVALID_UINT;
        this.DISPLAYTYPE_MONO = 0;
        this.DISPLAYTYPE_GRAY = 1;
        this.DISPLAYTYPE_RGB = 2;
        this.DISPLAYTYPE_EPAPER = 3;
        this.DISPLAYTYPE_INVALID = -1;
        this.LAYERWIDTH_INVALID = YAPI.INVALID_UINT;
...
YDisplay.STARTUPSEQ_INVALID = YAPI.INVALID_STRING;
YDisplay.BRIGHTNESS_INVALID = YAPI.INVALID_UINT;
YDisplay.AUTOINVERTDELAY_INVALID = YAPI.INVALID_UINT;
...
YDisplay.DISPLAYPANEL_INVALID = YAPI.INVALID_STRING;
YDisplay.DISPLAYWIDTH_INVALID = YAPI.INVALID_UINT;
YDisplay.DISPLAYHEIGHT_INVALID = YAPI.INVALID_UINT;
...
YDisplay.LAYERWIDTH_INVALID = YAPI.INVALID_UINT;
