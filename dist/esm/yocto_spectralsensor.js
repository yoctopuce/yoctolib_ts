...
export class YSpectralSensor extends YFunction {
    ...
    constructor(yapi, func) {
        ...
        this.LEDCURRENT_INVALID = YAPI.INVALID_INT;
        this.RESOLUTION_INVALID = YAPI.INVALID_DOUBLE;
        this.INTEGRATIONTIME_INVALID = YAPI.INVALID_INT;
        this.GAIN_INVALID = YAPI.INVALID_INT;
        ...
        this.ESTIMATEDXYZ_INVALID = YAPI.INVALID_STRING;
        this.ESTIMATEDOKLAB_INVALID = YAPI.INVALID_STRING;
        this.NEARRAL1_INVALID = YAPI.INVALID_STRING;
        this.NEARRAL2_INVALID = YAPI.INVALID_STRING;
        this.NEARRAL3_INVALID = YAPI.INVALID_STRING;
        this.NEARHTMLCOLOR_INVALID = YAPI.INVALID_STRING;
        this.NEARSIMPLECOLOR_INVALID = YAPI.INVALID_STRING;
        this.LEDCURRENTATPOWERON_INVALID = YAPI.INVALID_INT;
        this.INTEGRATIONTIMEATPOWERON_INVALID = YAPI.INVALID_INT;
        this.GAINATPOWERON_INVALID = YAPI.INVALID_INT;
...
YSpectralSensor.LEDCURRENT_INVALID = YAPI.INVALID_INT;
YSpectralSensor.RESOLUTION_INVALID = YAPI.INVALID_DOUBLE;
YSpectralSensor.INTEGRATIONTIME_INVALID = YAPI.INVALID_INT;
YSpectralSensor.GAIN_INVALID = YAPI.INVALID_INT;
...
YSpectralSensor.SATURATION_INVALID = YAPI.INVALID_UINT;
YSpectralSensor.ESTIMATEDRGB_INVALID = YAPI.INVALID_UINT;
YSpectralSensor.ESTIMATEDHSL_INVALID = YAPI.INVALID_UINT;
YSpectralSensor.ESTIMATEDXYZ_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.ESTIMATEDOKLAB_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.NEARRAL1_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.NEARRAL2_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.NEARRAL3_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.NEARHTMLCOLOR_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.NEARSIMPLECOLOR_INVALID = YAPI.INVALID_STRING;
YSpectralSensor.LEDCURRENTATPOWERON_INVALID = YAPI.INVALID_INT;
YSpectralSensor.INTEGRATIONTIMEATPOWERON_INVALID = YAPI.INVALID_INT;
YSpectralSensor.GAINATPOWERON_INVALID = YAPI.INVALID_INT;
