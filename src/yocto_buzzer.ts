...
export class YBuzzer extends YFunction
{
    ...
    _className: string;
    _frequency: number = YBuzzer.FREQUENCY_INVALID;
    _volume: number = YBuzzer.VOLUME_INVALID;
    _playSeqSize: number = YBuzzer.PLAYSEQSIZE_INVALID;
    ...
    public readonly PLAYSEQSIZE_INVALID: number = YAPI.INVALID_UINT;
    public readonly PLAYSEQMAXSIZE_INVALID: number = YAPI.INVALID_UINT;
    public readonly PLAYSEQSIGNATURE_INVALID: number = YAPI.INVALID_UINT;
    ...
    public static readonly PLAYSEQSIZE_INVALID: number = YAPI.INVALID_UINT;
    public static readonly PLAYSEQMAXSIZE_INVALID: number = YAPI.INVALID_UINT;
    ...
    imm_parseAttr(name: string, val: any)
    {
        ...
        case 'volume':
            ...
            return 1;
        case 'playSeqSize':
            this._playSeqSize = <number> <number> val;
            return 1;
        case 'playSeqMaxSize':
            this._playSeqMaxSize = <number> <number> val;
            return 1;
        case 'playSeqSignature':
            this._playSeqSignature = <number> <number> val;
            return 1;
        case 'command':
    ...
    {
        let tempo: number;
        let prevPitch: number;
        let prevDuration: number;
        let prevFreq: number;
        let note: number;
        let num: number;
        let typ: number;
        let ascNotes: Uint8Array;
        let notesLen: number;
        let i: number;
        let ch: number;
        let dNote: number;
        ...
        while (i < notesLen) {
            ...
            if (((ch == 32) || (i+1 == notesLen)) && ((note > -99) || (typ != 3))) {
                ...
                ms = <number> Math.round(320000.0 / (tempo * num));
                if (typ == 0) {
