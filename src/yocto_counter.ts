...
export class YCounter extends YSensor
{
     ...
     * @noreturn
     */
    async registerValueCallback(callback: YCounter.ValueCallback | null): Promise<number>
    {
        let val: string;
        if (callback != null) {
     ...
     * @noreturn
     */
    async registerTimedReportCallback(callback: YCounter.TimedReportCallback | null): Promise<number>
    {
