...
export class YSms
{
    ...
    _mclass: number = 0;
    _stamp: string = '';
    _udh: Uint8Array = new Uint8Array(0);
    _udata: Uint8Array = new Uint8Array(0);
    _npdu: number = 0;
    _pdu: Uint8Array = new Uint8Array(0);
    _parts: YSms[] = [];
    _aggSig: string = '';
    _aggIdx: number = 0;
    _aggCnt: number = 0;
    ...
    async get_smsc(): Promise<string>
    {
        return this._smsc;
    }

    async get_msgRef(): Promise<number>
    {
        return this._mref;
    }
    ...
    async get_alphabet(): Promise<number>
    {
        return this._alphab;
    }
    ...
    async get_userData(): Promise<Uint8Array>
    {
        return this._udata;
    }
    ...
    async get_partCount(): Promise<number>
    {
        if (this._npdu == 0) {
    ...
    async get_pdu(): Promise<Uint8Array>
    {
        if (this._npdu == 0) {
            await this.generatePdu();
        }
    ...
    async get_concatSignature(): Promise<string>
    {
        if (this._npdu == 0) {
            await this.generatePdu();
        }
    ...
    async get_concatIndex(): Promise<number>
    {
        if (this._npdu == 0) {
            await this.generatePdu();
        }
    ...
    async get_concatCount(): Promise<number>
    {
        if (this._npdu == 0) {
            await this.generatePdu();
        }
    ...
    async set_slot(val: number): Promise<number>
    {
        this._slot = val;
        return YAPI.SUCCESS;
    }

    async set_received(val: boolean): Promise<number>
    {
        this._deliv = val;
        return YAPI.SUCCESS;
    }
    ...
    async set_msgRef(val: number): Promise<number>
    {
        this._mref = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_sender(val: string): Promise<number>
    {
        this._orig = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_recipient(val: string): Promise<number>
    {
        this._dest = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_protocolId(val: number): Promise<number>
    {
        this._pid = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_alphabet(val: number): Promise<number>
    {
        this._alphab = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_msgClass(val: number): Promise<number>
    {
        if (val == -1) {
            this._mclass = 0;
        } else {
    ...
    async set_timestamp(val: string): Promise<number>
    {
        this._stamp = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async set_userDataHeader(val: Uint8Array): Promise<number>
    {
        this._udh = val;
        this._npdu = 0;
    ...
    async set_userData(val: Uint8Array): Promise<number>
    {
        this._udata = val;
        this._npdu = 0;
        return YAPI.SUCCESS;
    ...
    async convertToUnicode(): Promise<number>
    {
        let ucs2: number[] = [];
        let udatalen: number;
        let i: number;
     ...
     */
    async addText(val: string): Promise<number>
    {
        let udata: Uint8Array;
        let udatalen: number;
        let newdata: Uint8Array;
        let newdatalen: number;
        let i: number;
        if ((val).length == 0) {
            return YAPI.SUCCESS;
        }
     ...
     * @return YAPI.SUCCESS when the call succeeds.
     */
    async addUnicodeData(val: number[]): Promise<number>
    {
        let arrlen: number;
        let newdatalen: number;
        let i: number;
    ...
    async set_pdu(pdu: Uint8Array): Promise<number>
    {
        this._pdu = pdu;
        this._npdu = 1;
    ...
    async set_parts(parts: YSms[]): Promise<number>
    {
        let sorted: YSms[] = [];
        let partno: number;
        let initpartno: number;
        let i: number;
        let retcode: number;
        let totsize: number;
    ...
    async encodeAddress(addr: string): Promise<Uint8Array>
    {
    ...
    async decodeAddress(addr: Uint8Array, ofs: number, siz: number): Promise<string>
    {
        let addrType: number;
        let gsm7: Uint8Array;
        let res: string;
    ...
    async encodeTimeStamp(exp: string): Promise<Uint8Array>
    {
        let explen: number;
        let i: number;
        let res: Uint8Array;
        let n: number;
        let expasc: Uint8Array;
        let v1: number;
        let v2: number;
        explen = (exp).length;
        if (explen == 0) {
    ...
    async decodeTimeStamp(exp: Uint8Array, ofs: number, siz: number): Promise<string>
    {
        let n: number;
        let res: string;
        let i: number;
    ...
    async udataSize(): Promise<number>
    {
        let res: number;
        let udhsize: number;
    ...
    async encodeUserData(): Promise<Uint8Array>
    {
        let udsize: number;
        let udlen: number;
        let udhsize: number;
    ...
    async generateParts(): Promise<number>
    {
        let udhsize: number;
        let udlen: number;
        let mss: number;
    ...
    async generatePdu(): Promise<number>
    {
        let sca: Uint8Array;
        let hdr: Uint8Array;
        let addr: Uint8Array;
    ...
    async parseUserDataHeader(): Promise<number>
    {
        let udhlen: number;
        let i: number;
        let iei: number;
    ...
    async parsePdu(pdu: Uint8Array): Promise<number>
    {
        let rpos: number;
        let addrlen: number;
        let pdutyp: number;
...
/** @extends {YFunction} **/
export class YMessageBox extends YFunction
{
    //--- (generated code: YMessageBox attributes declaration)
    _className: string;
    _slotsInUse: number = YMessageBox.SLOTSINUSE_INVALID;
    _slotsCount: number = YMessageBox.SLOTSCOUNT_INVALID;
    _slotsBitmap: string = YMessageBox.SLOTSBITMAP_INVALID;
    ...
    _pdus: YSms[] = [];
    _messages: YSms[] = [];
    _gsm2unicodeReady: boolean = false;
    _gsm2unicode: number[] = [];
    _iso2gsm: Uint8Array = new Uint8Array(0);

    // API symbols as object properties
    public readonly SLOTSINUSE_INVALID: number = YAPI.INVALID_UINT;
    public readonly SLOTSCOUNT_INVALID: number = YAPI.INVALID_UINT;
    public readonly SLOTSBITMAP_INVALID: string = YAPI.INVALID_STRING;
    public readonly PDUSENT_INVALID: number = YAPI.INVALID_UINT;
    public readonly PDURECEIVED_INVALID: number = YAPI.INVALID_UINT;
    public readonly OBEY_INVALID: string = YAPI.INVALID_STRING;
    public readonly COMMAND_INVALID: string = YAPI.INVALID_STRING;

    // API symbols as static members
    public static readonly SLOTSINUSE_INVALID: number = YAPI.INVALID_UINT;
    public static readonly SLOTSCOUNT_INVALID: number = YAPI.INVALID_UINT;
    public static readonly SLOTSBITMAP_INVALID: string = YAPI.INVALID_STRING;
    public static readonly PDUSENT_INVALID: number = YAPI.INVALID_UINT;
    public static readonly PDURECEIVED_INVALID: number = YAPI.INVALID_UINT;
    public static readonly OBEY_INVALID: string = YAPI.INVALID_STRING;
    ...
    imm_parseAttr(name: string, val: any): number
    {
        ...
        case 'slotsInUse':
            ...
            return 1;
        case 'slotsCount':
            this._slotsCount = <number> <number> val;
            return 1;
        case 'slotsBitmap':
            this._slotsBitmap = <string> <string> val;
            return 1;
        case 'pduSent':
            this._pduSent = <number> <number> val;
            return 1;
        case 'pduReceived':
            this._pduReceived = <number> <number> val;
            return 1;
        case 'obey':
            this._obey = <string> <string> val;
            return 1;
        case 'command':
     ...
     */
    async get_slotsInUse(): Promise<number>
    {
        let res: number;
     ...
     */
    async get_slotsCount(): Promise<number>
    {
        let res: number;
        if (this._cacheExpiration <= this._yapi.GetTickCount()) {
            if (await this.load(this._yapi.defaultCacheValidity) != this._yapi.SUCCESS) {
    ...
    async get_slotsBitmap(): Promise<string>
    {
        let res: string;
        if (this._cacheExpiration <= this._yapi.GetTickCount()) {
            if (await this.load(this._yapi.defaultCacheValidity) != this._yapi.SUCCESS) {
     ...
     */
    async get_pduSent(): Promise<number>
    {
        let res: number;
        if (this._cacheExpiration <= this._yapi.GetTickCount()) {
            if (await this.load(this._yapi.defaultCacheValidity) != this._yapi.SUCCESS) {
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_pduSent(newval: number): Promise<number>
    {
        let rest_val: string;
     ...
     */
    async get_pduReceived(): Promise<number>
    {
        let res: number;
        if (this._cacheExpiration <= this._yapi.GetTickCount()) {
            if (await this.load(this._yapi.defaultCacheValidity) != this._yapi.SUCCESS) {
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_pduReceived(newval: number): Promise<number>
    {
        let rest_val: string;
        rest_val = String(newval);
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async set_obey(newval: string): Promise<number>
    {
        let rest_val: string;
        rest_val = String(newval);
    ...
    async nextMsgRef(): Promise<number>
    {
    ...
    async initGsm2Unicode(): Promise<number>
    {
        let i: number;
        let uni: number;
    ...
    async gsm2unicode(gsm: Uint8Array): Promise<number[]>
    {
        let i: number;
        let gsmlen: number;
        let reslen: number;
    ...
    async gsm2str(gsm: Uint8Array): Promise<string>
    {
        let i: number;
        let gsmlen: number;
        let reslen: number;
    ...
    async str2gsm(msg: string): Promise<Uint8Array>
    {
        let asc: Uint8Array;
        let asclen: number;
        let i: number;
     ...
     * On failure, throws an exception or returns a negative error code.
     */
    async clearPduCounters(): Promise<number>
    {
        let retcode: number;
     ...
     */
    async get_messages(): Promise<YSms[]>
    {
        await this.checkNewMessages();
